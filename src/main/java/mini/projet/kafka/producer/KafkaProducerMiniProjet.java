...
public final class KafkaProducerMiniProjet {

	private static KafkaProducerMiniProjet INSTANCE = null;
	...
	public static KafkaProducerMiniProjet getProducer() {
		if (INSTANCE == null)
			INSTANCE = new KafkaProducerMiniProjet();
		return INSTANCE;
	}

	private KafkaProducerMiniProjet() {
